...
alias g++c="g++ -Wall -Werror -Wextra -std=c++98"
alias c++c="c++ -Wall -Werror -Wextra -std=c++98"
alias clang++c="clang++ -Wall -Wextra -Werror -std=c++98"
...
alias valgrindh="valgrind --tool=helgrind"
...
export LF_RESET_LESS_TERMCAP=$'\e[0m'
export LESSHISTFILE=-

ln -f $HOME/Documents/cursus42/4_cpp/cpp/create_class_cpp $HOME/.local/bin/create_class_cpp
